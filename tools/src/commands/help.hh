  ...
  requires(recipes::__using_gnu)
{
  ...
  mc::console("    doctor     build with compiler-specific timing and optimization remarks:");
  mc::console("               GCC uses -ftime-report/-fopt-info; Clang uses -ftime-report/-Rpass");
  ...
  mc::console("                   duck splat verify_compile_clang.duck");
  ...
  mc::console("    --arm             target ARM (Linaro GCC, or Clang with its runtime/sysroot)");
  mc::console("                      (armv7-a, NEON, hard-float); run via `emulate`/`test`");
  mc::console("    --arm64           target AArch64 (Linaro GCC, or Clang cross driver; armv8-a)");
  ...
  mc::set_color(mc::color::reset);
  mc::console("    -O0 -O1 -O2 -O3   compiler optimization levels");
  ...
  mc::console("    --no-lto          drop default LTO (GCC -flto=8, Clang -flto=thin)");
  ...
  mc::set_color(mc::color::reset);
  mc::console("    Optimized recipe (default) adds -march=native and LTO:");
  mc::console("        GCC: -flto=8 plus -fmodulo-sched/-fgcse-* tuning");
  mc::console("        Clang: -flto=thin; -Ofast maps to -O3 -ffast-math");
  mc::console("    Debug recipe adds:");
  mc::console("        -g3 -ggdb3 -gcolumn-info -ginline-points -gstatement-frontiers");
  mc::console("        -march=native");
  mc::console("    x86 ISA level (--isa <level>, default native):");
  mc::console("        base    -march=x86-64      SSE2                 (any x86-64; micron's floor)");
  mc::console("        v2      -march=x86-64-v2   +SSE4.2, POPCNT      (Nehalem+)");
  mc::console("        v3      -march=x86-64-v3   +AVX2, BMI1/2, FMA   (Haswell+)");
  mc::console("        v4      -march=x86-64-v4   +AVX-512             (Skylake-X+)");
  mc::console("        native  -march=native      this box");
  ...
  mc::console("        C++: -fdiagnostics-color=always");
  mc::console("        GCC only: -fext-numeric-literals -fconcepts-diagnostics-depth=2");
  mc::console("    Doctor adds GCC timing/memory/opt-info reports, or Clang timing and");
  mc::console("        -Rpass/-Rpass-missed/-Rpass-analysis optimization remarks");
  ...
  mc::console("        gcc or clang driver, arch flags only; links unless --obj/--pp");
  mc::console("    Sanitizers (--asan/--ubsan/--tsan/--lsan) drop default LTO (incompatible);");
  ...
  mc::console("    duck splat verify_compile_clang.duck  # print every Clang matrix command");
