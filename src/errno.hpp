...
constexpr int permissions = 1;
constexpr int no_entry = 2;
constexpr int no_process = 3;
constexpr int interrupted = 4;
constexpr int io_error = 5;
constexpr int no_such_device = 6;
constexpr int arguments_too_big = 7;
constexpr int exec_error = 8;
constexpr int bad_file_number = 9;
constexpr int no_child_process = 10;
constexpr int try_again = 11;
constexpr int out_of_memory = 12;
constexpr int permission_denied = 13;
constexpr int bad_address = 14;
constexpr int block_device_req = 15;
constexpr int device_busy = 16;
constexpr int file_exists = 17;
constexpr int exdev = 18;
constexpr int no_device = 19;
constexpr int not_a_dir = 20;
constexpr int is_a_dir = 21;
constexpr int invalid_arg = 22;
constexpr int file_table_ovflw = 23;
constexpr int too_many_files = 24;
constexpr int not_a_tty = 25;
constexpr int text_busy = 26;
constexpr int file_too_big = 27;
constexpr int no_space = 28;
constexpr int illegal_seek = 29;
constexpr int read_only_fs = 30;
constexpr int too_many_links = 31;
constexpr int broken_pipe = 32;
constexpr int out_of_domain = 33;
constexpr int not_representable = 34;
constexpr int deadlock = 35;
constexpr int name_too_long = 36;
constexpr int no_record_locks = 37;
constexpr int bad_syscall = 38;
