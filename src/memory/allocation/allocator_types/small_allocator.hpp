...
// small allocation variant of the serial allocator
template<is_policy P = small_allocation_policy> class allocator_small: private abc_allocator<byte>
{

public:
  ~allocator_small() = default;
  allocator_small() = default;
  allocator_small(const allocator_small &o) = default;
  allocator_small(allocator_small &&o) = default;
  allocator_small &operator=(const allocator_small &o) = default;
  allocator_small &operator=(allocator_small &&o) = default;
