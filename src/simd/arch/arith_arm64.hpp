...
// mappings
//  _mm_and_si128        : vandq_s32
//  _mm_andnot_si128(a,b): vbicq_s32(b, a)
//  _mm_or_si128         : vorrq_s32
//  _mm_xor_si128        : veorq_s32
//  _mm_slli_epi*        : vshlq_s*(a, vdupq_n_s*(+n))
//  _mm_srli_epi*        : vshlq_u*(a, vdupq_n_s*(-n))
//  _mm_srai_epi*        : vshlq_s*(a, vdupq_n_s*(-n))
//  _mm_add_epi*         : vaddq_s*
//  _mm_adds_epi*        : vqaddq_s*
//  _mm_adds_epu*        : vqaddq_u*
//  _mm_sub_epi*         : vsubq_s*
//  _mm_subs_epi*        : vqsubq_s*
//  _mm_subs_epu*        : vqsubq_u*
//  _mm_hadd_epi*        : vuzpq + vaddq
//  _mm_hadd[s]_epi16    : vuzpq + vqaddq
//  _mm_hsub_epi*        : vuzpq + vsubq
//  _mm_hsubs_epi16      : vuzpq + vqsubq
//  _mm_mullo_epi16      : vmulq_s16
//  _mm_mullo_epi32      : vmulq_s32
//  _mm_mullo_epi64      : NONE
//  _mm_mulhi_epi16      : vshrn_n_s32 x vmull_s16
//  _mm_mulhi_epu16      : vshrn_n_u32 x vmull_u16
//  _mm_mul_epi32        : vmull_s32 on even 32-bit lanes
//  _mm_mul_epu32        : vmull_u32 on even 32-bit lanes
//  _mm_madd_epi16       : vpadd_s32 x vmull_s16
//  _mm_maddubs_epi16    : multiply u8×s8, hadds pairs
//  _mm_avg_epu*         : vrhaddq_u*
//  _mm_sign_epi*        : vcgtq/vcltq + vbslq/vnegq
//  _mm_min/max_epi*     : vminq/vmaxq_s*
//  _mm_min/max_epu*     : vminq/vmaxq_u*
//  _mm_abs_epi*         : vabsq_s*
//  _mm_sad_epu8         : vabdq_u8 + triple vpaddlq
//  _mm_cmpeq_epi*       : vceqq_s*  arm64
//  _mm_cmpgt_epi*       : vcgtq_s*  arm64
//  _mm_packs_epi16      : vcombine_s8 x vqmovn_s16
//  _mm_packs_epi32      : vcombine_s16 x vqmovn_s32
//  _mm_packus_epi16     : vcombine_u8 x vqmovun_s16
//  _mm_packus_epi32     : vcombine_u16 x vqmovun_s32
//  _mm_unpacklo_epi*    : vzipq_s*.val[0]
//  _mm_unpackhi_epi*    : vzipq_s*.val[1]
//  _mm_unpack*_epi64    : vcombine_s64 x vget_*_s64
#pragma once
...
cmpeq_64(T &o, T &b)
{
  return _ru64r(vceqq_s64(_ri64(__r(o)), _ri64(__r(b))));
}
...
cmpgt_64(T &o, T &b)
{
  return _ru64r(vcgtq_s64(_ri64(__r(o)), _ri64(__r(b))));
}
