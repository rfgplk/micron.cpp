...
#error "__vector_types_arm64.hpp included on a non-aarch64 build"
#endif
...
typedef float64_t float64x1_t __attribute__((__vector_size__(8), __may_alias__));
...
typedef float64_t float64x2_t __attribute__((__vector_size__(16), __may_alias__));
...
__micron_neon_tuples_for(float64x1);
...
__micron_neon_tuples_for(float64x2);
...
static_assert(sizeof(int16x4_t) == 8 && alignof(int16x4_t) == 8);
static_assert(sizeof(int32x2_t) == 8 && alignof(int32x2_t) == 8);
static_assert(sizeof(int64x1_t) == 8 && alignof(int64x1_t) == 8);
static_assert(sizeof(float32x2_t) == 8 && alignof(float32x2_t) == 8);
static_assert(sizeof(float64x1_t) == 8 && alignof(float64x1_t) == 8);

static_assert(sizeof(int8x16_t) == 16 && alignof(int8x16_t) == 16);
static_assert(sizeof(int16x8_t) == 16 && alignof(int16x8_t) == 16);
static_assert(sizeof(int32x4_t) == 16 && alignof(int32x4_t) == 16);
static_assert(sizeof(int64x2_t) == 16 && alignof(int64x2_t) == 16);
static_assert(sizeof(uint8x16_t) == 16 && alignof(uint8x16_t) == 16);
static_assert(sizeof(uint16x8_t) == 16 && alignof(uint16x8_t) == 16);
static_assert(sizeof(uint32x4_t) == 16 && alignof(uint32x4_t) == 16);
static_assert(sizeof(uint64x2_t) == 16 && alignof(uint64x2_t) == 16);
static_assert(sizeof(float32x4_t) == 16 && alignof(float32x4_t) == 16);
static_assert(sizeof(float64x2_t) == 16 && alignof(float64x2_t) == 16);

static_assert(sizeof(int8x16x2_t) == 32 && sizeof(int8x16x3_t) == 48 && sizeof(int8x16x4_t) == 64);
static_assert(sizeof(uint8x16x2_t) == 32);
...
using ::micron::simd::__bits::float64_t;
...
using ::micron::simd::__bits::float64x1_t;
...
using ::micron::simd::__bits::float64x2_t;
...
using ::micron::simd::__bits::float64x1x2_t;
using ::micron::simd::__bits::float64x1x3_t;
using ::micron::simd::__bits::float64x1x4_t;
...
using ::micron::simd::__bits::float64x2x2_t;
using ::micron::simd::__bits::float64x2x3_t;
using ::micron::simd::__bits::float64x2x4_t;
