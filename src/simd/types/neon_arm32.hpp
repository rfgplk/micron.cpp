...
{
  static_assert(!micron::same_as<T, f128> || micron::same_as<F, __vf>, "v128<f128,...>: lane type F must be __vf (float)");
...
public:
  ...
  v128(i64 a)
    requires micron::is_same_v<T, i128>
  {
    value = vreinterpretq_s32_s64(vdupq_n_s64(static_cast<int64_t>(a)));
  }
  ...
  v128(i8 _e0, i8 _e1, i8 _e2, i8 _e3, i8 _e4, i8 _e5, i8 _e6, i8 _e7, i8 _e8, i8 _e9, i8 _e10, i8 _e11, i8 _e12, i8 _e13, i8 _e14, i8 _e15)
    requires micron::is_same_v<T, i128>
  {
    // arg0 -> lane0 (natural order, matching the i32/i64/f32 ctors + x86)
  ...
  operator=(i64 l)
  {
    value = vreinterpretq_s32_s64(vdupq_n_s64(static_cast<int64_t>(l)));
    return *this;
  }
  ...
  {
    if constexpr ( micron::is_same_v<T, f128> ) {
      auto _ne = veorq_u32(vceqq_f32(value, o.value), vreinterpretq_u32_s32(neon_all_ones_si128()));
  ...
  operator*=(const v128 &o)
  {
    if constexpr ( micron::is_same_v<T, f128> ) {
      ...
      if constexpr ( __is_8_wide<F>() ) {
        static_assert(!__is_8_wide<F>(), "No epi8 SIMD multiply (ARMv7)");
      }
      if constexpr ( __is_16_wide<F>() )
  ...
  {
    if constexpr ( micron::is_same_v<T, f128> ) {
      value = neon_v7_divq_f32(value, o.value);
    } else if constexpr ( micron::is_same_v<T, i128> ) {
      static_assert(!micron::is_same_v<T, i128>, "No SIMD integer division (ARMv7)");
    }
    return *this;
  }
  ...
  operator/(const v128 &o) const
  {
    v128 _d;
    if constexpr ( micron::is_same_v<T, f128> ) {
      _d.value = neon_v7_divq_f32(value, o.value);
    } else if constexpr ( micron::is_same_v<T, i128> ) {
      static_assert(!micron::is_same_v<T, i128>, "No SIMD integer division (ARMv7)");
    }
    return _d;
  ...
  andnot(const v128 &o) const
  {
    v128 _r;
    if constexpr ( micron::is_same_v<T, i128> )
      _r.value = vreinterpretq_s32_u8(vandq_u8(vmvnq_u8(vreinterpretq_u8_s32(value)), vreinterpretq_u8_s32(o.value)));
    return _r;
  }
  ...
  movemask(void) const
  {
    if constexpr ( micron::is_same_v<T, i128> ) {
      ...
      uint8x16_t sat = vcgtq_u8(vreinterpretq_u8_s32(value), vdupq_n_u8(0x7f));
