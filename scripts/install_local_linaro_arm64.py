...
default_dest_dir = "/usr/gcc-linaro-aarch64/aarch64-none-linux-gnu/libc/usr/include/micron"
    ...
    for root, _, files in os.walk(external_path):
        for f in files:
            if (
                ...
                or f in ("coroutine", "initializer_list", "index_sequence", "pthread", "meta", "compare")
            ):
